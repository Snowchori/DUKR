		...
		<main>
			...
			<div class="container mt-3">
				<table class="table">
					...
					<tr>
						<td onclick="location.href='#'">&nbsp&nbsp&nbsp&nbsp 이거 완전 운빨 게임 아님?</br>
							<small>&nbsp&nbsp&nbsp&nbsp 카탄매니아유저 &nbsp&nbsp&nbsp 2023.06.30 &nbsp&nbsp <i class="bi bi-hand-thumbs-up-fill"></i>5</small>
						</td>
					</tr>
					<tr>
						<td onclick="location.href='#'">&nbsp&nbsp&nbsp&nbsp 이거 완전 운빨 게임 아님?</br>
